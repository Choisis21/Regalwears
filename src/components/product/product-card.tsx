    ...
    <article className={cn("group", className)}>
      <div className="relative aspect-[3/4] overflow-hidden rounded-2xl bg-secondary">
        ...
        <button
          ...
          className="absolute top-3 right-3 flex size-9 items-center justify-center rounded-full bg-cream/90 text-burgundy opacity-0 shadow-sm backdrop-blur-sm transition-all duration-300 hover:text-rosegold group-hover:opacity-100"
        >
